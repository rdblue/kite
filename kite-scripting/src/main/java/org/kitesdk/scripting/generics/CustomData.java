...
package org.kitesdk.scripting.generics;
...
public class CustomData extends GenericData {
  ...
  private static class GetNames implements Function<Schema, List<String>> {
    @Override
  ...
  private final LoadingCache<Schema, List<String>> fieldNamesCache =
      CacheBuilder.newBuilder().build(CacheLoader.from(new GetNames()));
  ...
  public DatumWriter createDatumWriter(Schema schema) {
    return new CustomDatumWriter(schema, this);
  }
