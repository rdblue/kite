...
# misc crash
import org.kitesdk.lang.Analytic as JavaAnalytic
import org.kitesdk.lang.generics.CustomData.GENERIC_SCHEMA as SCHEMA
import org.kitesdk.lang.utils.ToTableShim as ToTableShim

# carrier classes
import org.kitesdk.lang.carriers.Combiner as Combiner
import org.kitesdk.lang.carriers.FromCollection as FromCollection
import org.kitesdk.lang.carriers.FromTable as FromTable
import org.kitesdk.lang.carriers.FromGroupedTable as FromGroupedTable
    ...
    def _carrier_for( self, stage, func ):
        ...
        * the arity of the function:
        ...
        if isinstance( self._last_collection, PGroupedTable ):
            ...
            return FromTable
        elif isinstance( self._last_collection, PCollection ):
        ...
        raise RuntimeError('Last collection is invalid')
